...
#define ZCL_GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x08  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
	  ...
	  { 0x0006, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x00  } }, /* 40 Cluster: Over the Air Bootloading, Attribute: OTA Upgrade Status, Side: client*/ \
		  ...
		  { 0x0011, ZCL_LONG_OCTET_STRING_ATTRIBUTE_TYPE, 253, (ATTRIBUTE_MASK_CLIENT), { NULL } }, /* 43 Cluster: Green Power, Attribute: proxy table, Side: client*/ \
...
#define ZCL_GENERATED_CLUSTERS { \
  { 0x0000, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[0]), 14, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  ...
	  { 0x0021, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[42]), 8, 295, CLUSTER_MASK_CLIENT, NULL } /* 18, Endpoint Id: 242, Cluster: Green Power, Side: client*/ \
	 }
...
#define ZCL_GENERATED_ENDPOINT_TYPES { \
  { ((sl_zigbee_af_cluster_t*)&(generatedClusters[0])), 9, 54 }, \
	  ...
	  { ((sl_zigbee_af_cluster_t*)&(generatedClusters[18])), 1, 295 }, \
	 } 
// Largest attribute size is needed for various buffers
#define ZCL_ATTRIBUTE_LARGEST (253)

// Total size of singleton attributes
#define ZCL_ATTRIBUTE_SINGLETONS_SIZE (185)

// Total size of attribute storage
#define ZCL_ATTRIBUTE_MAX_SIZE (467)
